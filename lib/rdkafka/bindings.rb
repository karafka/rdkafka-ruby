  ...
  module Bindings
    ...
    class TopicResult
      ...
      def initialize(pointer)
        @result_error = Rdkafka::Bindings.rd_kafka_topic_result_error(pointer)
        @error_string = Rdkafka::Bindings.rd_kafka_topic_result_error_string(pointer)
        @result_name = Rdkafka::Bindings.rd_kafka_topic_result_name(pointer)
      end
    end
