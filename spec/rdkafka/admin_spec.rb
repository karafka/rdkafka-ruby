    ...
    describe 'called with invalid input' do
      ...
      describe 'with an invalid partition count' do
        ...
        it 'raises an exception' do
          ...
          end.to raise_error Rdkafka::Config::ConfigError, /num_partitions out of expected range/
        end
      end
      ...
      describe 'with an invalid replication factor' do
        ...
        it 'raises an exception' do
          expect do
            admin.create_topic(topic_name, topic_partition_count, topic_replication_factor)
          end.to raise_error Rdkafka::Config::ConfigError, /replication_factor out of expected range/
        end
      end
      ...
      describe 'with an invalid topic configuration' do
        it "doesn't create the topic" do
          ...
          expect do
            create_topic_handle.wait(max_wait_timeout: 15.0)
          end.to raise_error Rdkafka::RdkafkaError, /Broker: Configuration is invalid \(invalid_config\)/
        end
      end
    end
    ...
    context 'edge case' do
      context 'where we are unable to get the background queue' do
        ...
        it 'raises an exception' do
          expect do
            admin.create_topic(topic_name, topic_partition_count, topic_replication_factor)
          end.to raise_error Rdkafka::Config::ConfigError, /rd_kafka_queue_get_background was NULL/
        end
      end
