...
describe Rdkafka::Admin::DescribeAclReport do
  before do
    ...
    @report = described_class.new(acls: describe_acls_array_ptr, acls_count: 1)
  end

  it "gets matching acl resource type as Rdkafka::Bindings::RD_KAFKA_RESOURCE_TOPIC" do
    assert_equal Rdkafka::Bindings::RD_KAFKA_RESOURCE_TOPIC, @report.acls[0].matching_acl_resource_type
  end
  ...
  it "gets matching acl resource pattern type as Rdkafka::Bindings::RD_KAFKA_RESOURCE_PATTERN_LITERAL" do
    assert_equal Rdkafka::Bindings::RD_KAFKA_RESOURCE_PATTERN_LITERAL, @report.acls[0].matching_acl_resource_pattern_type
    assert_equal Rdkafka::Bindings::RD_KAFKA_RESOURCE_PATTERN_LITERAL, @report.acls[0].matching_acl_pattern_type
  end

  it "gets matching acl principal as User:anonymous" do
    assert_equal "User:anonymous", @report.acls[0].matching_acl_principal
  end

  it "gets matching acl host as *" do
    assert_equal "*", @report.acls[0].matching_acl_host
  end

  it "gets matching acl operation as Rdkafka::Bindings::RD_KAFKA_ACL_OPERATION_READ" do
    assert_equal Rdkafka::Bindings::RD_KAFKA_ACL_OPERATION_READ, @report.acls[0].matching_acl_operation
  end

  it "gets matching acl permission_type as Rdkafka::Bindings::RD_KAFKA_ACL_PERMISSION_TYPE_ALLOW" do
    assert_equal Rdkafka::Bindings::RD_KAFKA_ACL_PERMISSION_TYPE_ALLOW, @report.acls[0].matching_acl_permission_type
  end
end
