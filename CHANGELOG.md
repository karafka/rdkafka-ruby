...
- [Enhancement] Add `with_inner` method on `Producer`, `Consumer`, and `Admin` for advanced users who need thread-safe direct access to the native librdkafka handle for custom operations.
